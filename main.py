    ...
    for i in range(0, 10):  # remember 5 is not included
        for coin in coins:
            ...
            if api["data"][i]["symbol"] == coin["symbol"]:
                ...
                current_val = Label(pycrypto, text="${0:.2f}".format(
                    current_value), bg="#DDDDDD", fg="black", font="Segoe 12", padx="5", pady="5", borderwidth=2, relief="groove")
                current_val.grid(row=coin_row, column=4, sticky=N+S+E+W)

                pl_coin = Label(pycrypto, text="${0:.2f}".format(
                    pl_percoin), bg="#DDDDDD", fg="black", font="Segoe 12", padx="5", pady="5", borderwidth=2, relief="groove")
                pl_coin.grid(row=coin_row, column=5, sticky=N+S+E+W)

                totalpl = Label(pycrypto, text="${0:.2f}".format(
                    total_pl), bg="#DDDDDD", fg="black", font="Segoe 12", padx="5", pady="5", borderwidth=2, relief="groove")
...
name = Label(pycrypto, text="Price", bg="#30475E", fg="#DDDDDD",
             font="Segoe 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
name.grid(row=0, column=1, sticky=N+S+E+W)

name = Label(pycrypto, text="Coin Owned", bg="#30475E", fg="#DDDDDD",
             font="Segoe 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
name.grid(row=0, column=2, sticky=N+S+E+W)

name = Label(pycrypto, text="Total amount paid", bg="#30475E", fg="#DDDDDD",
             font="Segoe 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
name.grid(row=0, column=3, sticky=N+S+E+W)

name = Label(pycrypto, text="Current Value", bg="#30475E", fg="#DDDDDD",
             font="Segoe 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
name.grid(row=0, column=4, sticky=N+S+E+W)

name = Label(pycrypto, text="P/L Per coin", bg="#30475E", fg="#DDDDDD",
             font="Segoe 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
name.grid(row=0, column=5, sticky=N+S+E+W)

name = Label(pycrypto, text="Total P/L", bg="#30475E", fg="#DDDDDD",
             font="Segoe 12 bold", padx="5", pady="5", borderwidth=2, relief="groove")
